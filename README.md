...
in all web browsers. Service worker registration [won't be attempted](components/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](components/registerServiceWorker.js), which
